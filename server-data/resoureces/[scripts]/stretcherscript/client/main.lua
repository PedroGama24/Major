...
local labels = {        
	{ "REDNECK_AMBO_HELP", "Pressione ~INPUT_CONTEXT~ para abrir/fechar portas traseiras. ~n~Pressione ~INPUT_HUD_SPECIAL~ para mover extensor. ~n~Pressione ~INPUT_FRONTEND_SELECT~ para abrir/fechar compartimentos." },
	{ "REDNECK_AMBO_HELP2", "Pressione ~INPUT_CONTEXT~ para abrir/fechar portas traseiras. ~n~Pressione ~INPUT_DETONATE~ para levar maca.~n~Pressione ~INPUT_HUD_SPECIAL~ para mover extensor.~n~Pressione ~INPUT_FRONTEND_SELECT~ abrir/fechar compartimentos." },
	{ "REDNECK_AMBO_HELP3", "Pressione ~INPUT_CONTEXT~ para abrir/fechar portas traseiras. ~n~Pressione ~INPUT_DETONATE~ para guardar a maca.~n~Pressione ~INPUT_HUD_SPECIAL~ para mover extensor." }
}
		...
		for _,i in pairs(lit) do
			...
			if DoesEntityExist(closestObject) then
				...
				if WarMenu.IsMenuOpened('hopital') then
					...
					if WarMenu.Button('Fechar Menu') then
