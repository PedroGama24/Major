...
creatorCoords = vec3(-71.06, -804.73, 243.41) -- vec3(-1062.02,-2711.85,0.83)
creatorHeading = 53.24 --226.2


spawnCoords = vec3(-1144.32, -2792.37, 27.71)
spawnHeading = 242.01

maxHealth = 300 -- vida máxima do player
...
RegisterNetEvent("nation_creator:setInvisible")
AddEventHandler("nation_creator:setInvisible", function(value)
    continuousFadeOutNetwork = value
end)
...
function initCreator()
    ...
    TriggerEvent("nation_creator:setInvisible", true)
...
function finishCreator()
    ...
    SetEntityHealth(ped, GetPedMaxHealth(ped))
    func._updateLogin()
    TriggerEvent("nation_creator:setInvisible", false)
