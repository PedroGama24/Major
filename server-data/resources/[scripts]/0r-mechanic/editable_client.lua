...
RegisterNetEvent("0r-mechanic:client:receiveVehicleTuning")
AddEventHandler("0r-mechanic:client:receiveVehicleTuning", function(tuning)
    local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
    if vehicle and tuning then
        setVehicleProperties(vehicle, tuning)
    end
end)
