...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookbankrobbery = "https://discord.com/api/webhooks/1174171923891105924/f4cMJTmtpOOSAJeQiUR1wwWZC2JZYm74ntPjqOBW6jZzB8r5xrg60E7I1mOzhM0hUa0z"
        ...
        for l,w in pairs(soldado) do
            ...
            if player then
                async(function()
                    ...
                    TriggerClientEvent('chatMessage',player,"190",{64,64,255},"Roubo ao Banco Central iniciado, dirija-se até o local e intercepte os assaltantes.")
                    TriggerClientEvent("NotifyPush",player,{ code = 5, title = "Roubo ao Banco Central", x = x, y = y, z = z, badge = "O alarme disparou, verifique o ocorrido" })
